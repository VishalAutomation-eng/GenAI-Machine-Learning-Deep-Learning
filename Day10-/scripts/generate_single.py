...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a single GAN image.")
...
def main() -> None:
    ...
    output_path = Path(args.output) if args.output else paths.outputs_dir / f"single_{args.model_step}.png"

    generator = load_generator(model_path)
    image = generate_single_image(generator)
