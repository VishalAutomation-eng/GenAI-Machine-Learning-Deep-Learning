...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate variations from a base noise vector.")
...
def main() -> None:
    ...
    output_path = Path(args.output) if args.output else paths.outputs_dir / "variations.png"

    generator = load_generator(model_path)
    fig = generate_variations(generator)
